...
lld men_preference[501][501], women_preference[501][501], inv_women_preference[501][501];  //inv_women_prefernce keeps record of the the position of jth man in the women prefernce list

void stable_marriage(lld n)
{
	lld men[n+1], women[n+1], men_proposed_index[n+1], inv_women[n+1], i,w,m;       
	stack<lld> men_todo;
	for(i=1;i<=n;i++)
